...
public class PlayerController : NetworkBehaviour
{
    ...
    public UnityEvent<int> rightArmIndexUpdateEventInvoker;
    public UnityEvent<int> leftArmIndexUpdateEventInvoker;
    ...
    void Update()
    {
        ...
        UpdateRightArmImageServerRpc(transform.GetChild(2).GetChild(0).name, OwnerClientId);
        UpdateLeftArmImageServerRpc(transform.GetChild(1).GetChild(0).name, OwnerClientId);
    ...
    public void UpdateRightArmImageServerRpc(string armName, ulong senderClientId)
    {
        switch (armName)
        {
            case ("BasicShooter(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().rightArmIndex.Value = 0;
                break;

            case ("Beetle(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().rightArmIndex.Value = 1;
                break;

            case ("Silkworm(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().rightArmIndex.Value = 2;
                break;

            case ("HoneyBee(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().rightArmIndex.Value = 3;
                break;

            case ("Locust(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().rightArmIndex.Value = 4;
                break;
        }
    }
    [ServerRpc(RequireOwnership = false)]
    public void UpdateLeftArmImageServerRpc(string armName, ulong senderClientId)
    {
        switch (armName)
        {
            case ("BasicShooter(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().leftArmIndex.Value = 0;
                break;

            case ("Beetle(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().leftArmIndex.Value = 1;
                break;

            case ("Silkworm(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().leftArmIndex.Value = 2;
                break;

            case ("HoneyBee(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().leftArmIndex.Value = 3;
                break;

            case ("Locust(Clone)"):
                NetworkManager.Singleton.ConnectedClients[senderClientId].PlayerObject.GetComponent<PlayerController>().leftArmIndex.Value = 4;
                break;
        }
    }
    ...
    {
        leftArmIndexUpdateEventInvoker.Invoke(current);
    }
    ...
    public void RightArmUpgradeCheck(bool value)
    {
        if (value && inSpawn)
        {
            if (transform.GetChild(2).GetChild(0).GetComponent<Arm>().armLevel.Value == ArmLevel.Max) return;
    ...
    public void LeftArmUpgradeCheck(bool value)
    {
        if (value && inSpawn)
        {
            if (transform.GetChild(1).GetChild(0).GetComponent<Arm>().armLevel.Value == ArmLevel.Max) return;
